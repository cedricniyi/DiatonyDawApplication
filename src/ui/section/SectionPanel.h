...
public:
    ...
    void resized() override
    {
        ...
        fb.items.add(juce::FlexItem(overviewActionArea).withFlex(0.125f).withMargin({0, 0, 4, 0}));
        
        // Progression area en bas (90% de l'espace restant)
        fb.items.add(juce::FlexItem(progressionArea).withFlex(0.875f).withMargin({4, 0, 0, 0}));
