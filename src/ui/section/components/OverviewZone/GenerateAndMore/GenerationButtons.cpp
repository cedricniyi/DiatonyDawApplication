...
void GenerationButtons::paint(juce::Graphics& g)
{
    ColoredPanel::paint(g);
}

void GenerationButtons::resized()
{
...
StyledButton& GenerationButtons::getGenerateButton()
{
    return generateButton;
}

StyledButton& GenerationButtons::getMoreButton()
{
    return moreButton;
}

juce::Rectangle<int> GenerationButtons::getPreferredSize() const
{
